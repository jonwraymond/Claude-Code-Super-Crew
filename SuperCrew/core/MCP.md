# MCP.md - Claude Code Super Crew MCP Server Reference

MCP (Model Context Protocol) server integration and orchestration system for Claude Code Claude Code Super Crew framework.
