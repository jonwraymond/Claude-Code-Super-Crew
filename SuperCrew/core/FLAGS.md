# FLAGS.md - Claude Code Super Crew Flag Reference

Flag system for Claude Code Claude Code Super Crew framework with auto-activation and conflict resolution.
...
- Auto-activates: Claude Code Super Crew framework work, complex debugging
